...
<body>
	...
	%>
	<script>
		alert('Stop or Cancel or Pause Member!')
	</script>
	<%
		}
	%>
			...
			<div class="container_12">
				<div class="grid_4">
					<div class="block-1">
						...
						<p class="color-1">
							...
							the questions <a href="activityArrangePro" class="link"
								target="_blank">here</a> and earn credits if answer correctly.
							Just try!
						</p>
				...
				<div class="grid_4">
					<div class="block-1">
						...
						<p class="color-1">
							...
							records. Check them <a href="recordPro" class="link"
								target="_blank">here</a>. And maybe you need a consumption
							planning.
						</p>
				...
				<div class="grid_4">
					<div class="block-1">
						<h3>Infos</h3>
						<p class="color-1">
							This module shows you all your personal infos, including your
							Member info and Register info. Check them <a
					...
					<div class="left-1 page1-col1">
						...
						<p>
							...
							in the comming year. And you can learn more about the Cineplex <a
								href="about.jsp" class="link" target="_blank">here</a> in the
							About module.
						</p>
						<div class="block-2 wrap">
							<a href="allMoviesPro">Tickets Book</a>
							<p class="extra-wrap">
								Click here<strong>to book</strong><strong>the tickets</strong><strong>Now!</strong>
							</p>
						</div>
